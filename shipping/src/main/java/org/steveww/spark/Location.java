...
public class Location {
	...
	/**
	 * Calculate the distance between this location and the target location. Use decimal
	 * lat/long degrees Formula is Haversine
	...
	public long getDistance(double targetLatitude, double targetLongitude) {
		...
		double a = Math.sin(diffLatR / 2.0) * Math.sin(diffLatR / 2.0) + Math.cos(latitudeR) * Math.cos(targetLatitudeR)
